			...
			<el-card>
				...
				<el-col :md="12" :sm="24">
					<el-form-item label="(IRPJ) Imposto de Renda de Pessoa Jurídica​" prop="irpj">
						<el-input-number v-model="form.irpj"
						                 :disabled="loading"
				...
				<el-col :md="12" :sm="24">
					<el-form-item label="COFINS (Contribuição pa​ra Financiamento de Seguridade Social)" prop="cofins">
						<el-input-number v-model="form.cofins"
						                 :disabled="loading"
						                 controls-position="right"
						                 :min="0"
						                 :max="100"></el-input-number>
				...
				<el-col :md="12" :sm="24">
					<el-form-item label="(PIS) Programa de Integração Social" prop="pis">
						<el-input-number v-model="form.pis"
						                 :disabled="loading"
						                 controls-position="right"
						                 :min="0"
						                 :max="100"></el-input-number>
				...
				<el-col :md="12" :sm="24">
					<el-form-item label="(CSLL) Contribuição Social sobre Lucro Líquido" prop="csll">
						<el-input-number v-model="form.csll"
						                 :disabled="loading"
						                 controls-position="right"
						                 :min="0"
						                 :max="100"></el-input-number>
				...
				<el-col :md="12" :sm="24">
					<el-form-item label="(ISS) Imposto sobre Serviço de Qualquer Natureza" prop="iss">
						<el-input-number v-model="form.iss"
						                 :disabled="loading"
						                 controls-position="right"
						                 :min="0"
						                 :max="100"></el-input-number>
