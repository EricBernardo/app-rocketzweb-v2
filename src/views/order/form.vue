    ...
    getOrder() {
      ...
      if (__this.$route.params.id) {
        ...
        show(__this.$route.params.id).then(response => {
          ...
          __this.form.shipping_company_id = response.data.data.shipping_company_id
          __this.form.shipping_company_vehicle_id = response.data.data.shipping_company_vehicle_id
          __this.form.freight_value = response.data.data.freight_value
